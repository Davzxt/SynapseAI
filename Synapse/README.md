...
As rotas serverless ficam em `/api/config`, `/api/chat` e `/api/admin/settings`. A chave Groq deve ficar somente nas variáveis da Vercel, nunca no JavaScript público.
